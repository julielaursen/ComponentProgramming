...
public class TicTacToeBoardImplTest_Laursen {
	...
	@Before
	public void setUp() {
		ticTacToeBoard_Laursen = new TicTacToeBoardImpl_Laursen();
	}
	...
	public void testTargetMethod() {
		...
		assertEquals(5, TicTacToeBoardImpl_Laursen.getSmallestIndex(moveArray, 3));
		assertEquals(-1, TicTacToeBoardImpl_Laursen.getSmallestIndex(moveArray, 9));
	}

	@Test(expected = AssertionError.class)
	public void testTargetMethod2() {
		int[] moveArray = new int[] { 0, 1, 2, 7, 5, 3, 6, 8, 4, 9, 6, 1 };
		TicTacToeBoardImpl_Laursen.getSmallestIndex(moveArray, 6);
	}
